...
def visualize(checkpoint, vis_type, num_envs):
    ...
    extra_opts = {
        ...
        "render": ["headless=False", "++train.params.config.player.print_stats=True", "++train.params.config.player.games_num=25", "capture_video=True", "capture_video_freq=1500", "capture_video_len=500", "force_render=False"]
    }
