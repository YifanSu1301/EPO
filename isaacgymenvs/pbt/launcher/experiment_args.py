...
def add_experiment_args(parser):
    ...
    parser.add_argument("--env", default="allegro_kuka", choices=["ant","allegro_kuka", "allegro_kuka_two_arms","franka_cube_stack","franka_cube_push", "shadow_hand", "allegro_hand", "trifinger", "franka_cabinet", "humanoid", "cont_mountain_car", "IndustRealTaskPegsInsert", "parkour", "Ingenuity"], type=str, help="Environment to run")
    ...
    # EPO args
    parser.add_argument("--epo", action='store_true', default=False, help="Whether to use EPO")
...
def get_experiment_run_description(args):
    ...
    mutation_dict = {
        ...
        "IndustRealTaskPegsInsert": "default_mutation",
        "parkour": "default_mutation",
        "Ingenuity": "default_mutation",
    }

    if args.minibatch_size is None:
        args.minibatch_size = 4*args.num_envs
    print(args.off_policy_ratio)
    ...
    cli = (f'python -m isaacgymenvs.train '
           ...
           + f'train.params.config.epo={args.epo} '
